...
{
    public class Cumulonimbus : ModMountData
    {
        public override void SetDefaults()
        {
            mountData.spawnDust = mod.DustType("CumulonimbusDust");
            mountData.buff = mod.BuffType("CumulonimbusMount");
        ...
        public override void UpdateEffects(Player player)
        {
            ...
            {
                Projectile.NewProjectile(x, y+h, 0, 10, Terraria.ID.ProjectileID.RainFriendly, 20, 0, player.whoAmI);
            }
            if (Main.rand.Next(25) == 0)
            {
                Projectile.NewProjectile(x, y + h, 0, 10, Terraria.ID.ProjectileID.BulletHighVelocity, 100, 0, player.whoAmI);
            }
        }
    }
}